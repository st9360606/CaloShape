...
/**
 * ??Ê≥®Ê?ÔºöReceiver ‰∏çËÉΩ??suspend I/OÔºåÊ?‰ª•Áî® SharedPreferencesÔºàÂ?Ê≠•Ô??ÄÁ©©„Ä?
 * ??Â§öË?Á≥ªÔ?key ?†‰? localeTag ÂæåÁ∂¥Ôºà‰?Â¶?zh-TW / en-USÔºâ„Ä?
 */
object FastingNotificationTemplates {
    ...
    /**
     * Á∞°ÂñÆÊ®°ÊùøÔºöÊîØ??{planCode} {startTime} {endTime}
     */
