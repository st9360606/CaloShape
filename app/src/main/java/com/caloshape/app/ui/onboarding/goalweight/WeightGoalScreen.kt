    ...
    Scaffold(
        ...
        bottomBar = {
            CaloShapeOnboardingBottomContainer {
                CaloShapeOnboardingPrimaryButton(
                    ...
                    onClick = {
                        if (isSaving || valueKg <= 0.0 || isWheelScrolling) {
        ...
        Column(
            ...
            CaloShapeOnboardingPickerHeader(
                title = stringResource(R.string.onboard_goal_weight_title),
                subtitle = stringResource(R.string.onboard_goal_weight_subtitle)
            )
