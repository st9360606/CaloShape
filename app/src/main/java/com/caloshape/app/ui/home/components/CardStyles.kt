...
object HomeCardStyles {
    @Composable
    fun isDark(): Boolean = CaloShapeColors.current().background == CaloShapeColors.Dark.background
    ...
    object Sheet {
        @Composable
        fun surface(): Color = if (HomeCardStyles.isDark()) Color(0xFF18151F) else CaloShapeColors.current().surface
    ...
    object Dialog {
        ...
        @Composable
        fun panel(): Color = if (HomeCardStyles.isDark()) Color(0xFF24212D) else CaloShapeColors.current().surfaceMuted

        @Composable
        fun border(): Color = if (HomeCardStyles.isDark()) Color(0xFF34303D) else CaloShapeColors.current().border
    }
    ...
    object Chart {
        ...
        @Composable
        fun insetSurface(): Color = if (HomeCardStyles.isDark()) Color(0xFF24212D) else CaloShapeColors.current().surfaceMuted
        ...
        @Composable
        fun footerSurface(): Color = if (HomeCardStyles.isDark()) Color(0xFF24212D) else CaloShapeColors.current().surfaceMuted

        @Composable
        fun tooltipSurface(): Color = if (HomeCardStyles.isDark()) Color(0xFF24212D) else CaloShapeColors.current().surface
    }
...
object CardStyles {
    ...
    @Composable
    fun bg(): Color = CaloShapeColors.current().surface

    @Composable
    fun border(): BorderStroke = BorderStroke(1.2.dp, CaloShapeColors.current().border)
}
